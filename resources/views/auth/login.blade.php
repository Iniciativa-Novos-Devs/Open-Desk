...
<form method="POST" action="{{ route('login') }}"
    class="pt-3 row d-flex justify-content-center">
    @csrf
    <div class="col-sm-10 col-md-8 pt-3 mb-3 text-center">
        <img class="mb-4 display-6" class="Responsive" src=" {{ asset('/imagens/logo.jpg') }}" alt="logo"
            width="72">
    </div>
    ...
    <div class="col-sm-10 col-md-8 pt-3 mb-3">
