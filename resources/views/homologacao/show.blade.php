...
@section('content')
    <div class="w-100">
        ...
        <div class="p-2 my-3 border rounded border-dark w-100">
            ...
            <div class="p-2 mt-2">
                <a href="@route('homologacao_show', $chamado->id)" class="btn btn-sm btn-outline-danger">Não homologar</a>
                <a href="@route('homologacao_show', $chamado->id)" class="btn btn-sm btn-success">Homologar</a>
            </div>
        </div>
