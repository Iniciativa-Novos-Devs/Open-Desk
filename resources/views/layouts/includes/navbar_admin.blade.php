        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              <li><a class="dropdown-item" href="#">Atividades das áreas</a></li>
              <li><a class="dropdown-item" href="#">Problemas das áreas</a></li>
              <li><a class="dropdown-item" href="#">Atendentes das áreas</a></li>
              <li><a class="dropdown-item" href="#">Visualizar chamado</a></li>
